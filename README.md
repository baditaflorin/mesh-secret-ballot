...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-secret-ballot-b5b5b5)](https://baditaflorin.github.io/mesh-secret-ballot/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-secret-ballot/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> Anonymous yes/no ballot via commit-reveal. Soft-anonymity, honest privacy section.

**Live → https://baditaflorin.github.io/mesh-secret-ballot/**

**Source → https://github.com/baditaflorin/mesh-secret-ballot**
...
git clone https://github.com/baditaflorin/mesh-secret-ballot
cd mesh-secret-ballot
npm install
npm run dev
```
...
- `mesh-secret-ballot:signalingUrl`
- `mesh-secret-ballot:turnTokenUrl`
- `mesh-secret-ballot:iceServers`
- `mesh-secret-ballot:room`
